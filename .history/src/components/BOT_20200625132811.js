...
export default function BOTscreen() {
  ...
  return (
    <div >
        <img onClick={handleOpen} src={Image} alt="Freda" style={{width: "80%",marginRight:"-3.5rem", cursor:"pointer"}}></img>
      <Modal
        open={open}
        hideBackdrop={true}
...
<div  style={{height: "94%",backgroundColor:"rgba(27,31,56,1)",borderLeft: "1px solid orange",borderTop: "1px solid orange", width:"300px", zIndex:5,position:"absolute",right:"0px",bottom:"0px",overflow:"hidden"}}> 
    ...
    <input id="input" type="text" style={{width: "90%",position:"relative",marginTop:".5rem",marginLeft:"5%",border: "1px solid #00c0ff", borderRadius:"20px",
