...
const rows = [
  { id: 'company_id',numeric: true, disablePadding: true, label: 'Company ID'},
  { id: 'acct_doc_header_id', numeric: true, disablePadding: true, label: 'Account Header ID' },
  ...
  { id: 'customer_number', numeric: false, disablePadding: true, label: 'Customer Number'},
  { id: 'fk_customer_map_id', numeric: false, disablePadding: true, label: 'Customer Map ID'},
  { id: 'customer_name',numeric: true, disablePadding: true, label: 'Name Of Customer'},
  { id: 'baseline_create_date', numeric: true, disablePadding: true, label: 'Baseline Date' },
  ...
  { id: 'cust_payment_terms', numeric: false, disablePadding: true, label: 'Customer Payment Terms'},
  { id: 'clearing_date', numeric: false, disablePadding: true, label: 'Clear Date'},
  { id: 'isOpen',numeric: true, disablePadding: true, label: 'Is Open Invoice'},
  { id: 'ship_date', numeric: true, disablePadding: true, label: 'Shipping Date' },
  ...
  { id: 'actual_open_amount', numeric: false, disablePadding: true, label: 'Actual Amount Outstanding'},
  { id: 'invoice_age',numeric: true, disablePadding: true, label: 'Age of Invoice'},
  { id: 'invoice_amount_doc_currency', numeric: true, disablePadding: true, label: 'Invoice Currency' },
  { id: 'predicted_type', numeric: true, disablePadding: false, label: 'Predicted Payment Type' },
  { id: 'predicted_amt', numeric: true, disablePadding: false, label: 'Predicted Amount' },
]
...
class EnhancedTable2 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [],
  ...
  fetchSearch(query) {
      Axios.get('http://localhost:8080/Summer_Internship_Backend/SecondSearch', {params: {"tosearch" : query}})
  ...
  componentWillMount() {
    this.fetchSearch(this.props.id);
  }
      ...
      <Paper className={classes.root}>
        ...
        <div className={classes.tableWrapper}  style={{color:"white"}}>
          <Table className={classes.table} aria-labelledby="tableTitle">
            ...
            <TableBody style={{color:"#ffffff", paddingLeft:"8px"}}>
              {stableSort(Array.from(this.state.data), getSorting(order, orderBy))
                ...
                .map(n => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell component="th" scope="row" padding="none" style={{color:"#ffffff"}}>{n.company_id}</TableCell>
                      ...
                      <TableCell align="right" style={{color:"#ffffff"}}>{n.invoice_date_norm}</TableCell>
                      ...
                      <TableCell align="right" style={{color:"#ffffff"}}>{n.dayspast_due}</TableCell>
                      <TableCell align="right" style={{color:"#ffffff"}}>{n.document_id}</TableCell>
                      <TableCell align="right" style={{color:"#ffffff"}}>{n.actual_open_amount}</TableCell>
                      <TableCell align="right" style={{color:"#ffffff"}}>{n.invoice_age}</TableCell>
                      <TableCell align="right" style={{color:"#ffffff"}}>{n.invoice_amount_doc_currency}</TableCell>
        ...
        <TablePagination
          ...
          style={{color:"#ffffff", backgroundColor: "#28324B", height:"4rem"}}
