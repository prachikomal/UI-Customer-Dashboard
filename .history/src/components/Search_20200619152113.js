...
class Search extends Component {
  ...
  fetchSearchAll() {
    Axios.get('http://localhost:8080/Summer_Internship_Backend/SimpleSearchAll')
  ...
  fetchSearch(query) {
      Axios.get('http://localhost:8080/Summer_Internship_Backend/SimpleSearch', {params: {"tosearch" : query}})
        .then((res) => this.setState({ data : res.data})
    ).catch(e => console.log(e))
  }
