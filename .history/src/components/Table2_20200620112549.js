  ...
  const classes = styles();  
    ...
    useEffect(() => {    
          ...
          const GetData = async () => {    
            ...
            const result = await axios('http://localhost:8080/Summer_Internship_Backend/Search'); 
...
<TableCell padding='checkbox'>
                ...
                <TableCell component={Link} to="/pathGoesHere" align="right">{p.customer_number}</TableCell>  
