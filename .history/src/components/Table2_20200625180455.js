...
class Search extends Component {
  ...
  NormalTable() {
    Axios.get('http://localhost:8080/1706431/Search')
  ...
  fetchSearch(query) {
      Axios.get('http://localhost:8080/1706431/DoSearch', {params: {"search" : query}})
        .then((res) => this.setState({ data : res.data})
    ).catch(e => console.log(e))
  }
        ...
        <CardContent>
          ...
          <div className={classes.search}>
            <div className={classes.searchIcon}>
              <SearchIcon autoid="search-icon" style={{ color: "white" }} />
            </div>
            <InputBase
          ...
          <Paper className={classes.root} elevation={0} style={{ marginTop:"-10%"}}>
            <Table className={classes.table}>
              <TableHead>
                <TableRow>
                  <TableCell autoid="customer-name" className={classes.textColor}>
                    Customer Name
                  </TableCell>
                  <TableCell  autoid="customer-number" className={classes.textColor}>
                    Customer Number
                  </TableCell>
