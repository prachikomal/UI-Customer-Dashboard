  ...
  render() {
    ...
    return (
      <Grid container spacing={16}>
        ...
        <Grid item xs={3}>
          <Paper className={classes.paper}><Sec1 heading="Total Customer" value="2091"/></Paper>
        </Grid>
        <Grid item xs={3}>
          <Paper className={classes.paper}><Sec1 heading="Total Open AR" value="$43M"/></Paper>
        </Grid>
        <Grid item xs={3}>
          <Paper className={classes.paper}><Sec1 heading="Average Days Delay" value="3 Days"/></Paper>
        </Grid>
        <Grid item xs={3}>
          <Paper className={classes.paper}><Sec1 heading="Total open invoice" value="347438"/></Paper>
        </Grid>
        <Grid item xs={3}>
          <Paper className={classes.paper}><Ltop heading="Total Amount by Company Card" /></Paper>
        ...
        <Grid item xs={9}>
          ...
          <Paper className={classes.paper}><Sec2 heading="Invoices" /><Users/>
          </Paper>
