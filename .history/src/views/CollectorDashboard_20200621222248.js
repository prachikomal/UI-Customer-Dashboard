...
avgday=() =>{
  axios.get('http://localhost:8080/Summer_Internship_Backend/avgdaydelay')
  .then((res) => {console.log(res.data);this.setState({ avgday : res.data})}
).catch(e => console.log(e))
}

openinvoice=() =>{
  axios.get('http://localhost:8080/Summer_Internship_Backend/totalopeninvoice')
  ...
  render() {
    ...
    return (
      <Grid container spacing={16}>
        ...
        style={{backgroundColor:'#1B1F38', height: 200, marginLeft: 8}}
      >
        <Analytic/>
      </Paper>
      <Paper
