  ...
  render() {
    ...
    return (
      <Grid container spacing={16}>
        ...
        <Grid item xs={3}>
          <Paper className={classes.paper}><Sec1 heading="Total Customer" value={this.state.totalCustomer}/></Paper>
        </Grid>
        <Grid item xs={3}>
          <Paper className={classes.paper}><Sec1 heading="Total Open AR" value={this.state.totalop}/></Paper>
        </Grid>
        <Grid item xs={3}>
          <Paper className={classes.paper}><Sec1 heading="Average Days Delay" value={this.state.avgday}/></Paper>
        </Grid>
        <Grid item xs={3}>
          <Paper className={classes.paper}><Sec1 heading="Total open invoice" value={this.state.openinvoice}/></Paper>
        </Grid>
        <Grid item xs={4}>
        <Paper
