...
import EnhanceTable from '../components/Users';
  ...
  render() {
    ...
    return (
      <Grid container spacing={16}>
        ...
        <Grid item xs={3}>
          <Paper className={classes.paper}><Sec1 heading="Total Customer" id="tc"  value={this.state.totalCustomer}/></Paper>
        </Grid>
        <Grid item xs={3}>
          <Paper className={classes.paper}><Sec1 heading="Total Open AR"  id="tr" value={this.state.totalop}/></Paper>
        </Grid>
        <Grid item xs={3}>
          <Paper className={classes.paper}><Sec1 heading="Average Days Delay" id="av" value={this.state.avgday}/></Paper>
        </Grid>
        <Grid item xs={3}>
          <Paper className={classes.paper}><Sec1 heading="Total open invoice" id="ti" value={this.state.openinvoice}/></Paper>
        </Grid>
        <Grid item xs={4}>
        <Paper
      ...
      >
        <Table2/>
          ...
          <Grid item xs={8} >
          <Paper  className={classes.paper} ><EnhanceTable /></Paper>
        </Grid>
