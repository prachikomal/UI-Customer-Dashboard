          ...
          <div className={classes.title}>
            {numSelected >= 1 ? (
              <Button
                ...
                //     objArray = this.state.records;
                //   } else {
                //     objArray = this.props.location.state.records;
                //   }
...
class CustomerDetails extends React.Component {
  ...
  fetchTable(query) {
    Axios.get("http://localhost:8080/1706431/SecondSearch", {
    ...
    return (
      <div>
        <Grid container xs={12} spacing={24}>
          ...
          <Grid item container xs={6} style={{ height: "4vw" }}>
            <h3 className={classes.dashboard}>Receivables Dashboard</h3>
            <Button className={classes.bot}>PROFESSOR </Button>
          </Grid>
        </Grid>
