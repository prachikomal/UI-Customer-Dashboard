...
//for the two dynamic card data
  ...
  const findOpenInvoices = (data) => {
    ...
    const totalOpenInvoices = isOpenArr.filter((i) => i === 1).length; //for all isOpen=1 we'll find the sum
    ...
    <Toolbar className={classes.root}>
      ...
      <Grid container>
        ...
        <Grid item container xs={4}>
          <Grid item xs={6}>
            <Typography  autoid="total-open-invoices-customer" variant="h5" style={{ color: "white" }}>
          ...
          <Grid item xs={6}>
            ...
            <Typography autoid="total-open-amount-customer" variant="h5" style={{ color: "white" }}>
        ...
        <Grid container xs={12} spacing={24}>
          <Grid item container xs={6} style={{ height: "4vw" }}>
            <IconButton aria-label="Back" color="primary">
              <Link to="/">
                <ArrowBackIcon autoid="navigation-back-button" style={{ color: "white" }} />
              </Link>
            </IconButton>
          </Grid>
          <Grid item container xs={6} style={{ height: "4vw" }}>
